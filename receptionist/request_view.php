    ...
    <div class="card-body">
        <?php
            ...
            if(isset($_POST['edit_btn']))
            {
                ...
                $sql = "SELECT * FROM visitor_tb v join admin_tb a on v.v_h_id=a.a_id WHERE v_id='$id' ";
            ...
            <div class="form-group col-md-6">
                <label>Reson</label>
                <input type="text" name="edit_v_host" class="form-control" value="<?php  echo $row['v_reson']; ?>">
            </div>
            <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-6">
                ...
                <select name="update_status"class="form-control" >
                    ...
                    <option value="Wating">Send To Host</option>
