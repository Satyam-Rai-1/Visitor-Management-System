...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary text-lg"> New Request <?php $a=$_SESSION['username'];?>
    </h6>
  </div>
  ...
  <?php
    ...
    <div class="card-body">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="hidden" name="v_r_id" class="form-control " 
                value = <?php      $sql = "SELECT * FROM  admin_tb WHERE a_email = '$a' ";
                         $result = $con->query($sql);
